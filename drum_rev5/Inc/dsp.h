...
q31_t sampleBufferA1[BUFFER_SIZE];
q31_t sampleBufferA2[BUFFER_SIZE];

q31_t sampleBufferB1[BUFFER_SIZE];
q31_t sampleBufferB2[BUFFER_SIZE];
...
int handleCoversionSlow(q31_t, int, controlRateInputs *, audioRateInputs *, uint32_t);
