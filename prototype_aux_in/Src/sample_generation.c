...
//		out = fix16_lerp(interp1, interp2, phaseFrac) >> 3;
//
//		// we use the interpolated nearest neighbor samples to determine the sign of rate of change
...
//
//		// interpolate between those based upon the fractional part of our phase pointer
//		a0 = fix16_mul(waveFrac, fix16_mul(waveFrac - 65536, waveFrac - 131072));
//		a1 = fix16_mul(waveFrac + 65536, fix16_mul(waveFrac - 65536, waveFrac - 131072));
//		a2 = fix16_mul(waveFrac, fix16_mul(waveFrac + 65536, waveFrac - 131072));
//		a3 = fix16_mul(waveFrac, fix16_mul(waveFrac + 65536, waveFrac - 65536));
//
//		out = (fix16_mul(a0, fix24_mul(interp0, -PRECALC1_6)) +
//				(fix16_mul(a1, interp1) >> 1) +
//				(fix16_mul(a2, -interp2) >> 1) +
//				fix16_mul(a3, fix24_mul(interp3, PRECALC1_6))) >> 3;
//
//		if (out > 4095){out = 4095;}
//		else if (out < 0){out = 0;}
//
...
//void loadSampleArrayNonDSP(Family family) {
