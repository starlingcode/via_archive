...
//check if the trigger button has been pressed
		...
		// in Middlewares/ST/STM32_TouchSensingLibrary/src/tsl_touchkey.c, a sensor signal is dispatched to the UI whenever a touchkey state changes

//		// OLD when acquisition is complete, send a signal to the UI state machine to parse the sensor readings
