...
//		}
		...
		if (tsl_status != TSL_USER_STATUS_BUSY) {
			touchkeyValues.button1Value = MyTKeys[1].p_ChD->Meas;
			touchkeyValues.button2Value = MyTKeys[0].p_ChD->Meas;
			touchkeyValues.button3Value = MyTKeys[2].p_ChD->Meas;
			touchkeyValues.button4Value = MyTKeys[3].p_ChD->Meas;
			touchkeyValues.button6Value = MyTKeys[4].p_ChD->Meas;
			touchkeyValues.button5Value = MyTKeys[5].p_ChD->Meas;
		}
