...
#define SHMASK 			0b000000000000000111000000000000
#define SHSHIFT 		12

// up to 32 families
#define FAMILYMASK		0b000000000011111000000000000000
#define FAMILYSHIFT		15

// up to 8 logic A types
#define LOGICAMASK		0b000000011100000000000000000000
#define LOGICASHIFT		20

// up to 8 logic B types
#define LOGICBMASK		0b000011100000000000000000000000
#define LOGICBSHIFT		23

// 2 auto duty types
#define AUTODUTYMASK	0b000100000000000000000000000000
